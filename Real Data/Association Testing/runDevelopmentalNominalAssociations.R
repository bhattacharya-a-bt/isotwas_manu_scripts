...
twas_folder="out_models_041923/Walker/TWAS"
isotwas_folder="out_models_041923/Walker/isoTWAS"
ld_folder = "out_models_041923/Walker/LD"
gwas_folder="/u/project/gandalm/margolis/alexandria/GWAS/02-ldsc-hm3-and-nohm3-sumstats"
...
dir.create(file.path('Walker/Associations',
                     tr),recursive = T)

outFile_twas = file.path('Walker/Associations',
                         tr,
                         paste0(tr,'_TWAS.tsv'))
outFile_isotwas = file.path('Walker/Associations',
                            tr,
